package pivx.org.pivxwallet.wallofcoins.buying_wizard;
...
import pivx.org.pivxwallet.wallofcoins.BuyPivPref;
...
import pivx.org.pivxwallet.wallofcoins.buying_wizard.location.BuyingWizardLocationFragment;
...
public class BuyingWizardBaseActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        init();
        setListners();
        if (!TextUtils.isEmpty(buyPivPref.getAuthToken())) {
            if (!TextUtils.isEmpty(buyPivPref.getHoldId())) {
                CreateHoldResp createHoldResp = buyPivPref.getCreateHoldResp();
    ...
    private void init() {
        this.buyPivPref = new BuyPivPref(PreferenceManager.getDefaultSharedPreferences(this));
        buyPivPref.registerOnSharedPreferenceChangeListener(this);
    ...
    protected void onDestroy() {
        super.onDestroy();
        buyPivPref.unregisterOnSharedPreferenceChangeListener(this);
    }
