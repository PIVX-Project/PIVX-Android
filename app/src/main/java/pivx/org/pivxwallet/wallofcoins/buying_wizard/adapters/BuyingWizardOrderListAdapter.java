package pivx.org.pivxwallet.wallofcoins.buying_wizard.adapters;
...
import pivx.org.pivxwallet.wallofcoins.buying_wizard.models.BuyingWizardAccountJson;
...
public class BuyingWizardOrderListAdapter extends RecyclerView.Adapter<BuyingWizardOrderListAdapter.VHolder> {
    ...
    public BuyingWizardOrderListAdapter(Context mContext, List<OrderListResp> orderList,
                                        ...
                                        BuyPivPref buyPivPref) {
        this.mContext = mContext;
        this.orderList = orderList;
        this.historyFragment = historyFragment;
        this.buyPivPref = buyPivPref;
    }
        ...
        if (orderListResp.id != -1 && orderListResp.id != -2 && orderListResp.id != -3) {
            ...
            if (orderListResp.nearestBranch != null) {
                if ((orderListResp.nearestBranch.address == null
                    ...
                    holder.itemBinding.buttonBuyPivItemLocation.setVisibility(View.VISIBLE);
                    holder.itemBinding.tvItrmOffer4.setVisibility(View.VISIBLE);
                } else {
                    holder.itemBinding.buttonBuyPivItemLocation.setVisibility(View.GONE);
                    holder.itemBinding.tvItrmOffer4.setVisibility(View.GONE);
                }
            }

            holder.itemBinding.buttonBuyPivItemLocation.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
...
//              you must deposit cash
            ...
            if (orderListResp.status.equals("WD")) {
                ...
                holder.itemBinding.orderPiv.setText("Total PIV: " + orderListResp.total + " (" + yourFormattedDots + " μⱣiv)\n"
                ...
                holder.itemBinding.orderPivInstruction.setVisibility(View.VISIBLE);
                ...
                holder.itemBinding.orderPivInstruction.setVisibility(View.GONE);
