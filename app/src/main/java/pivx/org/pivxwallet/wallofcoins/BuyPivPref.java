...
/**
 * Class for Manage Buy SharedPreferences
 * @author Andreas Schildbach
 */
public class BuyPivPref {
    ...
    private static final Logger log = LoggerFactory.getLogger(BuyPivPref.class);

    public BuyPivPref(final SharedPreferences prefs) {
        this.prefs = prefs;
        gson = new Gson();
    }
