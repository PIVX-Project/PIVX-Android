package pivx.org.pivxwallet.wallofcoins.buying_wizard.phone_list;
...
import pivx.org.pivxwallet.wallofcoins.buying_wizard.adapters.BuyingWizardPhoneListAdapter;
                ...
                public void onResponse(Call<GetAuthTokenResp> call, Response<GetAuthTokenResp> response) {
                    ...
                    if (code == 200) {
                        if (!TextUtils.isEmpty(response.body().token)) {
                            ...
                            ((BuyingWizardBaseActivity) mContext).buyPivPref.setDeviceId(response.body().deviceId);
